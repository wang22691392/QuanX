...
const shareCodes = [
  {
    zd: $.getdata("zd_shareCode1") || "4i3lthhaljspms6bf5dhbhrq6u",
    nc: $.getdata("nc_shareCode1") || "50fe2b00f71a4a139077cd2210a79e5d",
    mc: $.getdata("mc_shareCode1") || "MTAxODc2NTEzOTAwMDAwMDAyNzA5NTQyOQ==",
    ddgc: $.getdata("dd_shareCode1") || "P04z54XCjVWnYaS5uCrubZWRg",
    jxgc: $.getdata("jx_shareCode1") || "V2h7uSWTX7Og0y3tywQHig==",
    jdzz: $.getdata("zz_shareCode1") || "A3pbnSQML",
    joy: $.getdata("joy_shareCode1") || "x6zszk8Cckg=",
  },
  {
    zd: $.getdata("zd_shareCode2") || "4npkonnsy7xi2xh7wismk5bnxjpkt3b663ezoei",
    nc: $.getdata("nc_shareCode2") || "52e81b792d37447abbc8003dfa9035b9",
    mc: $.getdata("mc_shareCode2") || "MTAxODc2NTE0NzAwMDAwMDAyODMwNjM1Mw==",
    ddgc: $.getdata("dd_shareCode2") || "P04z54XCjVWnYaS5m9cZ2eu2ntIlqTQh7OnO2E",
    jxgc: $.getdata("jx_shareCode2") || "DbVv6koUTP-bc_o75teNXA==",
    jdzz: $.getdata("zz_shareCode2") || "AUWE5mPuXyjcLXWjxji4bxw",
    joy: $.getdata("joy_shareCode2") || "-HotHOUZjcP_OKc1jXhTbat9zd5YaBeE",
  },
  {
